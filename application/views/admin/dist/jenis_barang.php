            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h3 class="m-0 text-dark">DATA JENIS BARANG</h3>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <form id="modalForm" action="<?= base_url('admin/insertOrUpdateJenisBarang') ?>" method="post">
                                    <div class="modal-body">
                                        <input type="text" id="id_utama" name="id" value="" hidden>
                                        <div class="form-group">
                                            <label class="d-block">Nama Jenis Barang</label>
                        ...
                        foreach ($jenisBarang as $row) : ?>
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <button class="edit_data btn btn-outline-success mb-1 ml-1 btn-sm " data-id="<?= $row->id_jenis_barang; ?>" data-toggle="modal" data-target="#exampleModal">Edit</button>
                                        <a href="<?= base_url("admin/deleteJenisBarang/$row->id_jenis_barang"); ?>" class="btn btn-outline-danger mb-1 ml-1 btn-sm">Delete</a>
                                    </td>
                                </tr>
                            </tbody>
                        <?php endforeach; ?>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.edit_data').on('click', function() {
                ...
                let id = $(this).data('id');
                $.ajax({
                    url: '<?= base_url('admin/jenisBarangForEdit/') ?>' + id,
                    type: 'GET',
                    dataType: 'json',
                    success: function(res) {
                        $('#id_utama').val(res.id_jenis_barang)
                        $('#nama').val(res.nama_jenis_barang);
                    }
                });
            });
